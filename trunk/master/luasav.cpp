...
#ifdef WIN32
				MessageBoxA(hFrameWnd, lua_tostring(L, -1), "Lua Error in SAVE function", MB_OK);
#else
...
#ifdef WIN32
				MessageBoxA(hFrameWnd, lua_tostring(L, -1), "Lua Error in LOAD function", MB_OK);
#else
